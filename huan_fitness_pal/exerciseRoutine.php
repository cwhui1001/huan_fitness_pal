...
if (isset($_POST['search'])) {
    ...
    switch ($searchType) {
        ...
        case 'Dancing':
        case 'Pilates':
            $query = "SELECT * FROM exerciseroutine WHERE custId = '$custId' AND category = '$searchType' ORDER BY recordDate ASC";
            break;
        case 'last_week':
            ...
            $query = "SELECT * FROM exerciseroutine WHERE custId = '$custId' AND recordDate BETWEEN '$startOfLastWeek' AND '$endOfLastWeek' ORDER BY recordDate ASC";
            break;
        case 'last_month':
            ...
            $query = "SELECT * FROM exerciseroutine WHERE custId = '$custId' AND recordDate BETWEEN '$startOfLastMonth' AND '$endOfLastMonth' ORDER BY recordDate ASC";
            break;
        case 'date':
            $query = "SELECT * FROM exerciseroutine WHERE custId = '$custId' AND recordDate = '$searchValue' ORDER BY recordDate ASC";
            break;
        default:
            $query = "SELECT * FROM exerciseroutine WHERE custId = '$custId' ORDER BY recordDate ASC";
    }
